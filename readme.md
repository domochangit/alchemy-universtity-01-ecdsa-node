...
2. Run `npm install` to install all the depedencies 
3. Run `node index` to start the server or `nodemon index` for the auto restart, or rather `npx nodemon index.js` or `npm run serve` as it in package.json scripts
